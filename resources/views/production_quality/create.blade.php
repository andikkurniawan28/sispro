...
@section('title')
    {{ ucwords(str_replace('_', ' ', 'create_production_quality')) }}
@endsection
        ...
        <div class="row">
            <div class="col-xxl">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form action="{{ route("production_quality.store") }}" method="POST">
                            @csrf @method("POST")
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <select class="production_id" id="production_id" name="production_id" required autofocus>
                                        <option disabled selected>Select a production :</option>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="@if($quality->type == "Qualitative"){{ "text" }}@else{{ "number" }}@endif" class="form-control"
                                            ...
                                            value="{{ old(str_replace(" ", "_", $quality->name)) }}"
                                            step="any"
                                        >
                                    </div>
                                </div>
