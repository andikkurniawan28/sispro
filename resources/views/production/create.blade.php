...
@section('title')
    {{ ucwords(str_replace('_', ' ', 'create_production')) }}
@endsection
                    ...
                    <div class="card-body">
                        <form action="{{ route("production.store") }}" method="POST">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <select class="demand_id" id="demand_id" name="demand_id" required autofocus>
                                        <option disabled selected>Select a demand :</option>
                                        @foreach ($demands as $demand)
                                            <option value="{{ $demand->id }}">{{ $demand->code }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <select class="product_id" id="product_id" name="product_id" required autofocus>
                                        <option disabled selected>Select a raw product :</option>
                                        @foreach ($products as $product)
                                            <option value="{{ $product->id }}">{{ $product->code }} | @php echo str_replace('_', ' ', $product->name); @endphp</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="batch" name="batch" value="{{ old("batch") }}" required autofocus>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" class="form-control" id="accepted" name="accepted" value="{{ old("accepted") }}" required>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" class="form-control" id="rejected" name="rejected" value="{{ old("rejected") }}" required>
                                </div>
                            </div>
